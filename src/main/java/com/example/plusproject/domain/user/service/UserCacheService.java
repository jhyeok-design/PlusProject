...
public class UserCacheService {
    ...
    public List<UserReadResponse> get(
            String domain,
            String name,
            int page,
            int size,
        ...
        return (List<UserReadResponse>) redisTemplate.opsForValue()
                .get(key(domain, name, page, size, createdAt));
    }
    ...
    public void set(
            ...
            int size,
            LocalDateTime createdAt,
            List<UserReadResponse> value
    ) {
        redisTemplate.opsForValue().set(
                key(domain, name, page, size, createdAt),
                value,
